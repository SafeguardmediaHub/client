    ...
    <div className="space-y-3">
      ...
      {showDetails && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
          ...
          <div className="bg-green-50 rounded-md p-2 sm:p-3 border border-green-200">
            <p className="text-[10px] sm:text-xs text-green-700 mb-0.5 sm:mb-1">
              Completed
            </p>
          ...
          <div className="bg-blue-50 rounded-md p-2 sm:p-3 border border-blue-200">
            <p className="text-[10px] sm:text-xs text-blue-700 mb-0.5 sm:mb-1">
              Processing
            </p>
          ...
          <div className="bg-red-50 rounded-md p-2 sm:p-3 border border-red-200">
            <p className="text-[10px] sm:text-xs text-red-700 mb-0.5 sm:mb-1">
              Failed
            </p>
      ...
      {showDetails && remainingItems > 0 && (
        <div className="text-xs sm:text-sm text-gray-600 bg-blue-50 border border-blue-200 rounded-md p-2 sm:p-3">
