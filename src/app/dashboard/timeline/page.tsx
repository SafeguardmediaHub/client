                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-800 mb-3">
                          Temporal metadata is found in both images and videos
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
                    ...
                    <ol className="text-sm text-gray-700 space-y-1 list-decimal list-inside">
                      ...
                      <li>
                        We analyze temporal metadata and digital signatures
                      </li>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  <p className="text-sm text-blue-800">
                    ...
                    temporal metadata from the file and compare it with your
                    claimed date to detect inconsistencies or tampering.
                  </p>
                </div>
