        ...
        <div className="max-w-3xl mx-auto w-full">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 mt-2">
              Verify claimed locations by analyzing GPS metadata and
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-800 mb-3">
                          GPS metadata is typically found in images from cameras
                          and smartphones.
                        </p>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
                    ...
                    <ol className="text-sm text-gray-700 space-y-1 list-decimal list-inside">
                      ...
                      <li>
                        Coordinates are cross-referenced with claimed location
                      </li>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  <p className="text-sm text-blue-800">
                    ...
                    GPS coordinates from the image metadata and compare them
                    with the provided location to verify authenticity.
                  </p>
                </div>
